...
public class AddressBookDuplicateEntries {
	/**
	 * 
	 * @param args
	 * @throws IOException
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		 * To create address book by using array list data collection with Contact
		 * parameter
		 */
		...
		/*
		 * Here we are solving to use cases by using do while loop we can add data in which we can delete duplicare entries
		 */
		do {
			...
			case 2:
				/*
				 * This case will check for person name in address book and update it if it found name or report that person information is not found
				 */
				...
				for (int i = 0; i < addressBook1.size(); i++) {
					if (addressBook1.get(i).getFirstName().equals(name)) {
						...
						/*
						 * To set edited data at that position from the address book
						 */
						addressBook1.set(i,
								new Contact(firstName1, lastName1, address1, city1, state1, zip1, phoneNumber1, email1));
						System.out.println("Information updated successfully");
						status = true;
					}
				}
				/*
				 * If we not found any data it will print it from the address book
				 */
				if (!status) {
			...
			case 3:
				/*
				 * To take name from user and find if we found we will delete it form the address book
				 */

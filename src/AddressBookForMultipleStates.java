...
public class AddressBookForMultipleStates {
	/**
	 * 
	 * @param args
	 */
...
public static void main(String[] args) throws IOException {
		 ...
		 */
		HashMap<String,Contact> addressBook1=new HashMap<String,Contact>();
		
		/*
		 * To create address book with state and person inforamtion
		 */
		HashMap<String,Contact> addressBook2=new HashMap<String,Contact>();
		...
		Contact p1 = new Contact(br.readLine(),br.readLine(),br.readLine(),br.readLine(),br.readLine(), br.read(),br.readLine(),br2.readLine());
		System.out.println("enter person2 information");
		Contact p2 = new Contact(br1.readLine(),br1.readLine(),br1.readLine(),br1.readLine(),br1.readLine(), br1.read(),br1.readLine(),br1.readLine());
		System.out.println("enter person3 information");
		Contact p3 = new Contact(br2.readLine(),br2.readLine(),br2.readLine(),br2.readLine(),br2.readLine(), br2.read(),br2.readLine(),br2.readLine());
		 ...
		 * 
		 */
		Set<Map.Entry<String,Contact>> entries = addressBook1.entrySet();
		
		int count = 0;
		for(Map.Entry<String,Contact> p : entries) {
			if(p.getKey()==city) {
				count++;
				Contact person = p.getValue();
		 ...
		 * 
		 */
		Set<Map.Entry<String,Contact>> entries2 = addressBook2.entrySet();
		
		for(Map.Entry<String,Contact> p : entries2) {
			if(p.getKey()==state) {
				count1++;
			Contact person = p.getValue();
			System.out.println(person);
